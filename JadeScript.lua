...
local localVer = 0.3
async_http.init("raw.githubusercontent.com", "rwealm/JadeScript/blob/main/JadeScript.lua", function(output)
    ...
    if localVer ~= currentVer then
        ...
        menu.action(menu.my_root(), "Update JadeScript", {}, "", function()
            async_http.init('raw.githubusercontent.com', 'rwealm/JadeScript/blob/main/JadeScript.lua',function(a)
